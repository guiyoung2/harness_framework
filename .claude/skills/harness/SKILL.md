---
name: harness
description: 기능 단위·리스크가 큰 소프트웨어 작업을 phase/step으로 쪼개 계획·실행·검증·기록하기 위한 워크플로우. `/harness`, "하네스" 같은 호출이나 기능 단위 변경에 사용한다.
---

> **Codex 사용자:** 이 스킬 대신 `AGENTS.md`의 "Harness 워크플로우 (Codex)" 섹션을 참고하라.
